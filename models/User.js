  ...
  password: {
    ...
    validate: {
      validator: function (value) {
        ...
        const checks = [uppercaseCount >= 2, lowercaseCount >= 2, numberCount >= 2, specialCharCount >= 2];
        return checks.every(Boolean);
      },
      message: "Password must be at least 8 characters with minimum 2 uppercase, 2 lowercase, 2 numbers, and 2 special characters"
    },
    select: false
  },
  role: {
...
userSchema.pre("save", async function () {
  ...
  if (uppercaseCount < 2 || lowercaseCount < 2 || numberCount < 2 || specialCharCount < 2) {
    throw new Error("Password must contain at least 2 uppercase, 2 lowercase, 2 numbers, and 2 special characters");
  }
...
userSchema.methods.resetToDefaultPermissions = function (updatedBy) {
  this.customPermissions = this.resolvedRolePermissions || RolePermissions[this.role] || [];
  this.permissionsUpdatedBy = updatedBy;
  this.permissionsUpdatedAt = new Date();
  this.updatedBy = updatedBy;
};
