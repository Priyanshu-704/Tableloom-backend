...
const { createImageUploadHandler, handleUploadErrors } = require("../utils/uploadMiddleware");
...
router.put("/", hasPermission("SYSTEM_SETTINGS"), createImageUploadHandler({ folder: "images/restaurant-logo" }), handleUploadErrors, updateSettings);
