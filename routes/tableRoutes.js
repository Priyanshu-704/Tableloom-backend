...
router.put("/:id/status", hasPermission("TABLE_UPDATE_STATUS"), updateTableStatus);
router.put("/:id/toggle-active", hasPermission("TABLE_EDIT"), toggleTableActive);
...
router.get("/:id/qr-token-status", hasPermission("TABLE_VIEW_ALL"), getQRTokenStatus);
router.post("/:id/table-refresh-token", hasPermission("TABLE_EDIT"), refreshQRToken);
router.get("/dashboard/stats", hasPermission("TABLE_VIEW_ALL"), getTableStatistics);
